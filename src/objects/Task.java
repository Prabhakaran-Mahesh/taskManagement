...
public class Task {
    ...
    ArrayList<TeamMember> assignedMembers = new ArrayList<>();
    ArrayList<TeamMember> followers = new ArrayList<>();
    ...
    public ArrayList<TeamMember> getAssignedMembers() {
        return assignedMembers;
    }

    public void setAssignedMembers(ArrayList<TeamMember> assignedMembers) {
        this.assignedMembers = assignedMembers;
    }

    public ArrayList<TeamMember> getFollowers() {
        return followers;
    }

    public void setFollowers(ArrayList<TeamMember> followers) {
